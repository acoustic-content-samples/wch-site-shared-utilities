...
export class AuthService implements OnDestroy {
	...
	constructor(private http: HttpClient, private wchService: WchInfoService, private router: Router) {
		...
		this.userURL = `${wchService.apiUrl}user-profile/v1/users/currentuser`;
		this.loginURL = `${wchService.apiUrl}login/v1/basicauth`;
		this.logoutUrl = `${wchService.apiUrl}login/v1/removecookies`;
