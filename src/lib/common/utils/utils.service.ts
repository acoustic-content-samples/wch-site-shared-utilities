...
export class UtilsService {
	...
	getBodyImageUrl (renderingContext: RenderingContext, imageContext: any, imageKey: string, rendition: string): string {
		let renditionUrl = '';
		let elem = null;
		rendition = rendition.toLowerCase();
		if (imageContext && imageContext[imageKey]) {
				elem = imageContext[imageKey];
		}
